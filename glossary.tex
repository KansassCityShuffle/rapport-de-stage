...
{
  name={Kanban},
    description={Dans le domaine du développement logiciel le Kanban (issu de la méthode japonaise du même) consiste à instaurer des métriques visuelles attestant l'avancement d'un projet}
}